          ...
          {filtered.map((client) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3 mt-4 text-xs">
                ...
                {client.linkedinUrl && (
                  <a href={ensureAbsoluteUrl(client.linkedinUrl)} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[#0A66C2] hover:text-[#0A66C2]/80 transition-colors" title="LinkedIn Profile">
                ...
                {client.websiteUrl && (
                  <a href={ensureAbsoluteUrl(client.websiteUrl)} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-text-secondary hover:text-accent transition-colors" title="Website">
