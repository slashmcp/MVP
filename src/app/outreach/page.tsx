...
export function OutreachPageContent() {
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      ...
      const promptText = `Hi ${recipientName},\n\nI hope you're having a great week.\n\n${isClient ? 'I noticed your company has been growing rapidly and I have a few top-tier candidates that match your current engineering openings perfectly.' : 'I came across your impressive background and believe your skills are a perfect match for an exciting unlisted role we are recruiting for.'}\n\nWould you be open to a quick 10-minute chat this week to explore this further?\n\nBest regards,\nRecruitment Command Center`;
      
      setEmailBody(promptText);
      setIsGenerating(false);
      addToast({ type: 'success', message: 'Email draft generated by AI' });
    }, 1500);
  };
